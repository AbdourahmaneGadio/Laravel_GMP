...

{
    ...
    {
        $offresAlternance = Alternance::all(); // Récupère toutes les instances de Alternance

        return view('profile.profils-Eetudiant.offresAlternance', compact('offresAlternance'));
    }
